  ...
  return (
    <div className="our-people">
      ...
      <div className="member-1">
        <div className="name">
          <div className="designer-who-makes">
            ...
            experience in teaching, financial management, and entrepreneurship.
          </div>
        ...
        <div className="userpic">
          <img className="mask-icon" alt="" src="https://i.ibb.co/P9MZJ6t/Doroth.jpg" />
        </div>
      </div>
      <div className="member-11">
        <div className="name1">
          <div className="designer-who-makes1">
            Grace Bruintjies, our Chairperson, holds a prospective Ph.D. and is
            a co-researcher on the SU-cohort Community Engaged Teaching and
        ...
        <div className="userpic">
          <img className="mask-icon" alt="" src="https://i.ibb.co/jVw2t9L/grace.png" />
        </div>
      </div>
      ...
      <div className="member-13">
        <div className="name2">
          <div className="designer-who-makes2">
            holds a BA (Human Ecology) degree from the University of the Western
            Cape, and Certificates in NPO Management and Business Management
            Coaching from the University of Stellenbosch Business School.
          </div>
          <b className="product-manager2">Secretary</b>
          <div className="nicole-fisher3">Faith Brown</div>
        </div>
        <div className="userpic">
          <img className="mask-icon" alt="" src="https://i.ibb.co/bNQmS2r/faith.jpg" />
        </div>
      </div>
      <div className="member-14">
        ...
        <div className="userpic">
          <img className="mask-icon" alt="" src="https://i.ibb.co/bzS7Z59/Jade.png" />
        </div>
      </div>
